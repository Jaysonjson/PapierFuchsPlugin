...
public class FighterClassItem extends FuchsItem {

    public FighterClassItem(String id, Material material, IItemUseType itemUseType) {
    ...
    public ItemStack createItem(Player player, ItemStack stack) {
        ...
        oItem.setItem(ChatColor.RED + "Kämpfer");
        return oItem.item;
    }
