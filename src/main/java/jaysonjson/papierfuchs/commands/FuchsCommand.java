...
public class FuchsCommand implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender commandSender, @NotNull Command command, @NotNull String s, @NotNull String[] strings) {
        commandSender.sendMessage("Fuchs Plugin Version: " + ChatColor.AQUA + "" + PapierFuchs.version + ChatColor.RESET + " [" + ChatColor.GREEN + "1.16.3"+ ChatColor.RESET +"] - " + ChatColor.LIGHT_PURPLE + "Jayson.json");
